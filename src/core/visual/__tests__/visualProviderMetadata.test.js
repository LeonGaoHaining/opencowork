...
import { listVisualProviderCapabilities, normalizeVisualProviderSelection, resolveVisualProviderLabel, resolveVisualProviderSelection, } from '../visualProviderMetadata';
describe('visualProviderMetadata', () => {
    ...
    it('resolves direct and routed provider metadata consistently', () => {
        ...
        expect(resolveVisualProviderLabel({ taskRouting: { visualProvider: routed } })).toBe('Responses Computer');
        expect(listVisualProviderCapabilities({
            taskRouting: {
                visualProvider: {
                    ...routed,
                    capabilities: {
