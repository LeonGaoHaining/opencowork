...
describe('WebFetch Tools - Black Box Tests', () => {
  describe('UARotationManager', () => {
    let uaManager: UARotationManager;
  ...
  describe('HTMLConverter', () => {
    ...
    it('should strip script and style tags', () => {
      const html =
        '<script>alert("xss")</script><style>.hidden{display:none}</style><p>Content</p>';
      const markdown = converter.toMarkdown(html);
  ...
  describe('CookieManager', () => {
    ...
    it('should extract domain from URL', () => {
      const cookieManager = new CookieManager() as any;
